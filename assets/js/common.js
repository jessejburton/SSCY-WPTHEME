...
(function($) {
  $(document).ready(function() {
    ...
    $(window).on("scroll", function() {
      if ($(window).scrollTop() < 1000) {
        ...
        $(".hero").css("opacity", 1 - $(window).scrollTop() * 0.003);
      }
    });
  ...
  function showNextBanner() {
    ...
    if (currentBackground == 0) {
      $("body .hero").css(
        "background-image",
        "url(wp-content/themes/saltspringcentre/assets/css/images/intro-background-babaji.jpg)"
      );
    } else {
      $("body .hero").css(
        "background-image",
        "url(wp-content/themes/saltspringcentre/assets/css/images/Lotus_Background.jpg)"
      );
    }*/
  }
  ...
  function showPrevBanner() {
    ...
    if (currentBackground == 0) {
      ...
      $("body .hero").css(
        "background-image",
        "url(images/Lotus_Background.jpg)"
      );
    }*/
  }
