    ...
    <div class="header-primary">
      <div class="header__brand">
        <a class="home-link" href="<?php echo get_home_url(); ?>" title="Home">
          <img class="header__icon" src="<?php echo get_template_directory_uri() . '/images/sscy_lotus_white.svg'; ?>" />
        </a>
      </div>
        ...
        <div class="banner__content">
          <div class="banner__container">
            <div class="banner__logo">
              <img class="banner_lotus" src="<?php echo get_template_directory_uri() . '/images/sscy_lotus_white.svg'; ?>" />
              <img class="banner_logo-text" src="<?php echo get_template_directory_uri() . '/images/sscy_text_white.svg'; ?>" />
            </div>
          </div>
